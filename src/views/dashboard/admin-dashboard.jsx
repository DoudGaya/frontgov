...
import {File, FilePlus, Inbox, TrendingUp, UserCheck, Users, UserX} from "react-feather";
...
const AdminDashboard = (props) => {
    ...
    const getRecord = async () => {
        await axios.get(`${serverLink}report/dashboard/admin/${login_data.agency_id}`, login_data.token)
            .then((res) => {
