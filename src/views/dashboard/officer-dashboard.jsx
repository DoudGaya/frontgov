...
import {File, FilePlus, Inbox, TrendingUp} from "react-feather";
...
const OfficerDashboard = (props) => {
    ...
    const getRecord = async () => {
        await axios.get(`${serverLink}report/dashboard/officer/${login_data.user_id}`, login_data.token)
            .then((res) => {
    ...
    return isLoading ? <SpinnerLoader/> : (
        <div id='dashboard-ecommerce'>
            ...
            <Row>
                <Col xl='6' md='6' xs='12'>
                    <StatsCard title={'General'} cols={{ xl: '6', sm: '6' }} data={generalStats} />
                </Col>
                <Col xl='6' md='6' xs='12'>
...
export default connect(mapStateToProps, null)(OfficerDashboard)
