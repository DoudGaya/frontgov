...
import Table from "@src/component/common/table/table";
 ...
 function FolderTrack(props) {
    ...
    const [datatable2, setDatatable2] = useState({
                     ...
                     <div className="card-toolbar col-md-12 col-12 p-0">
                         <div className='d-flex justify-content-between align-items-center'>
                             <div className="col-md-12">
                                 <h4><FileText/>  Folder Tracking</h4>
                             </div>
     ...
     const getData = async () => {
         await axios.get(`${serverLink}file-manager/folder/track/${props.formData.folder_id}`, token)
             .then((result) => {
...
export default connect(mapStateToProps, null)(FolderTrack)